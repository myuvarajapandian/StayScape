...
<div class="container mb-2">
    ...
    <div class="row">
            ...
            <div class="container mt-2 mb-2">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class=" d-flex justify-content-between">
                            <h3 class="mt-4">
                                <strong style="color: #EE2A24;">Rs. {{ $rooms->rent }}<span style="color: black;"> / Day </span></strong>
                            </h3>
                        ...
                        <hr class="my-4">
                        <h4 class="mb-4"><i class="fa-solid fa-user"></i> <strong>Contact</strong></h4>
                        <div class="row">
                            <p><i class="fa-solid fa-phone"></i> +91{{ $owner->phone }}</p>
                            <a href="mailto:{{$owner->email }}" style="text-decoration: none; color: black;"><i class="fa-solid fa-envelope"></i> {{$owner->email }}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5">
            ...
            <div class="">
                <div>
                    <h4 class="mb-4"><i class="fa-solid fa-house"></i> Booking Info</h4>
                </div>
                <div class="mt-2">
                    <button type="button" class="btn btn-primary mt-2 mb-2" data-bs-toggle="modal" data-bs-target="#bookingDetailsModal">
                        View Booking Details
                    </button>
                    <p class="mt-1">Click the button above to view availability details (if room is not available for your dates).</p>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-end">
                                        <strong style="color: #198754; font-size: 1.5rem;">{{ $rooms->rent }} / Day</strong>
                                    </p>
                                </div>
                            </div>
                            <hr>
